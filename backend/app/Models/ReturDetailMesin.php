...
class ReturDetailMesin extends Model
{
    protected $table = 'retur_detail_mesins';
    protected $fillable = ['retur_barang_id', 'penerimaan_detail_id', 'qty_retur', 'alasan', 'foto_bukti', 'qty_pengganti', 'nomor_seri_pengganti', 'status_id'];
